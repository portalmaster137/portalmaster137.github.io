...
var LSCG = (function (exports) {
	...
	class HypnoModule extends BaseModule {
	    ...
	    load() {
	        ...
	        OnActivity(1, ModuleCategory.Hypno, (data, sender, msg, metadata) => {
	            ...
	            if (!this.Enabled)
	                return;
	            let target = (_a = data.Dictionary) === null || _a === void 0 ? void 0 : _a.find((d) => d.Tag == "TargetCharacter");
	            if (!!target && target.MemberNumber == Player.MemberNumber) {
	                ...
	                // Special tummy rub hypno action for Bean
	                    ...
	                    this.DelayedTriggerWord(sender === null || sender === void 0 ? void 0 : sender.MemberNumber);
	                }
	            }
	        });
	    ...
	    get awakeners() {
	        var _a, _b, _c;
	        return (_c = (_b = (_a = this.settings.awakeners) === null || _a === void 0 ? void 0 : _a.split(",")) === null || _b === void 0 ? void 0 : _b.filter(word => !!word).map(word => word.toLocaleLowerCase())) !== null && _c !== void 0 ? _c : [];
	    }
	    get triggers() {
	        var _a, _b, _c;
	        var overrideWords = (_c = (_b = (_a = this.settings.overrideWords) === null || _a === void 0 ? void 0 : _a.split(",")) === null || _b === void 0 ? void 0 : _b.filter(word => !!word).map(word => word.toLocaleLowerCase())) !== null && _c !== void 0 ? _c : [];
	    ...
	    getNewTriggerWord() {
	        ...
	        var words = (_c = (_b = (_a = this.settings.overrideWords) === null || _a === void 0 ? void 0 : _a.split(",")) === null || _b === void 0 ? void 0 : _b.filter((word, ix, arr) => !!word && arr.indexOf(word) == ix)) !== null && _c !== void 0 ? _c : [];
	        if (words.length <= 0)
	            words = commonWords;
	        if (words.length > 1 && words.indexOf(currentTrigger) > -1)
	            words = words.filter(val => val != currentTrigger);
	        return (_d = words[getRandomInt(words.length)]) === null || _d === void 0 ? void 0 : _d.toLocaleLowerCase();
	    }
	    allowedSpeaker(speaker) {
	        ...
	        var allowedMembers = (_c = (_b = this.settings.overrideMemberIds) === null || _b === void 0 ? void 0 : _b.split(",").map(id => +id).filter(id => id > 0)) !== null && _c !== void 0 ? _c : [];
	        if (allowedMembers.length <= 0)
	            return isAllowedMember(speaker);
	        else
	            return allowedMembers.includes(memberId);
	    }
	    DelayedTriggerWord(memberNumber = 0) {
	...
	class CollarModule extends BaseModule {
	    ...
	    get wearingCorrectCollar() {
	        ...
	        if (!this.settings.collar.creator) {
	            return (collar === null || collar === void 0 ? void 0 : collar.Asset.Name) == this.settings.collar.name;
	        }
	        else {
	            ...
	            var collarCreator = (_e = (_d = collar === null || collar === void 0 ? void 0 : collar.Craft) === null || _d === void 0 ? void 0 : _d.MemberNumber) !== null && _e !== void 0 ? _e : -1;
	    ...
	    load() {
	        ...
	        OnAction(6, ModuleCategory.Collar, (data, sender, msg, meta) => {
	            ...
	            if (!data.Dictionary || !data.Dictionary[2] || !data.Dictionary[3])
	                return;
	            var target = (_a = data.Dictionary[2]) === null || _a === void 0 ? void 0 : _a.MemberNumber;
	            if (target != Player.MemberNumber)
	                return;
	            if ((msg == "ActionSwap" || "ActionRemove") && ((_b = data.Dictionary[3]) === null || _b === void 0 ? void 0 : _b.GroupName) == "ItemNeck") {
	                this.ReleaseCollar();
	            }
	        });
	        ...
	        OnAction(6, ModuleCategory.Misc, (data, sender, msg, metadata) => {
	            ...
	            if (target == this.handChokingMember && msg == "ActionUse") {
	                if (((_b = data.Dictionary[3]) === null || _b === void 0 ? void 0 : _b.GroupName) == "ItemHands" || ((_c = data.Dictionary[3]) === null || _c === void 0 ? void 0 : _c.GroupName) == "ItemArms") {
	        ...
	        OnAction(100, ModuleCategory.Misc, (data, sender, msg, metadata) => {
	            ...
	            var target = (_b = (_a = data.Dictionary) === null || _a === void 0 ? void 0 : _a.find((dictItem) => dictItem.Tag == "DestinationCharacter")) === null || _b === void 0 ? void 0 : _b.MemberNumber;
	            if (!target)
	                var target = (_d = (_c = data.Dictionary) === null || _c === void 0 ? void 0 : _c.find((dictItem) => dictItem.Tag == "TargetCharacter")) === null || _d === void 0 ? void 0 : _d.MemberNumber;
	            if (!target)
	                var target = (_f = (_e = data.Dictionary) === null || _e === void 0 ? void 0 : _e.find((dictItem) => dictItem.Tag == "TargetCharacterName")) === null || _f === void 0 ? void 0 : _f.MemberNumber;
	            var targetGroup = (_h = (_g = data.Dictionary) === null || _g === void 0 ? void 0 : _g.find((dictItem) => dictItem.Tag == "FocusAssetGroup")) === null || _h === void 0 ? void 0 : _h.AssetGroupName;
	            if (target == Player.MemberNumber &&
	...
	class BoopsModule extends BaseModule {
	    ...
	    get IsIncapacitated() {
	        var _a, _b, _c, _d, _e, _f, _g;
	        return ((_b = (_a = Player.LSCG) === null || _a === void 0 ? void 0 : _a.HypnoModule) === null || _b === void 0 ? void 0 : _b.hypnotized) || ((_d = (_c = Player.LSCG) === null || _c === void 0 ? void 0 : _c.InjectorModule) === null || _d === void 0 ? void 0 : _d.asleep) || ((_f = (_e = Player.LSCG) === null || _e === void 0 ? void 0 : _e.InjectorModule) === null || _f === void 0 ? void 0 : _f.brainwashed) || ((_g = getModule("MiscModule")) === null || _g === void 0 ? void 0 : _g.isChloroformed);
	    }
	    BoopReact(booperId) {
	    ...
	    load() {
	        ...
	        OnAction(100, ModuleCategory.Misc, (data, sender, msg, metadata) => {
	            ...
	            if (target != Player.MemberNumber)
	                return;
	            if (msg == "ActionSwap") {
	                if (((_b = data.Dictionary[3]) === null || _b === void 0 ? void 0 : _b.AssetName) == "ChloroformCloth" && !this.IsWearingChloroform()) {
	                    this.RemoveChloroform();
	                }
	                else if (((_c = data.Dictionary[4]) === null || _c === void 0 ? void 0 : _c.AssetName) == "ChloroformCloth" && this.NumberChloroform() == 1) {
	                    this.AddChloroform(sender);
	                }
	                return;
	            }
	            var isChloroformAction = ((_d = data.Dictionary[3]) === null || _d === void 0 ? void 0 : _d.AssetName) == "ChloroformCloth";
	...
	class LipstickModule extends BaseModule {
	    ...
	    load() {
	        OnActivity(100, ModuleCategory.Lipstick, (data, sender, msg, metadata) => {
	            ...
	            if (!!target &&
	                ...
	                var item = (_b = data.Dictionary) === null || _b === void 0 ? void 0 : _b.find((d) => d.Tag == "ActivityAsset");
	    ...
	    addLipstickMarks() {
	        ...
	        InventoryWear(Player, "Kissmark", "Mask", "Default", 1, (_a = Player.MemberNumber) !== null && _a !== void 0 ? _a : 0, undefined, true);
	...
	class ActivityModule extends BaseModule {
	    ...
	    load() {
	        hookFunction("ServerSend", 100, (args, next) => {
	            ...
	            if (args[0] == "ChatRoomChat" && ((_a = args[1]) === null || _a === void 0 ? void 0 : _a.Type) == "Activity") {
	                let data = args[1];
	                let actName = (_c = (_b = data.Dictionary[3]) === null || _b === void 0 ? void 0 : _b.ActivityName) !== null && _c !== void 0 ? _c : "";
	                ...
	                if (actName.indexOf("LSCG_") == 0 || isPatched) {
	                    ...
	                    if (!!preParse)
	                        preParse(args);
	                    let target = (_d = data.Dictionary) === null || _d === void 0 ? void 0 : _d.find((d) => d.Tag == "TargetCharacter");
	        ...
	        OnActivity(1, ModuleCategory.Activities, (data, sender, msg, metadata) => {
	            var _a;
	            var dictionary = data === null || data === void 0 ? void 0 : data.Dictionary;
	            if (!dictionary || !dictionary[3])
	                return;
	            let target = dictionary === null || dictionary === void 0 ? void 0 : dictionary.find((d) => d.Tag == "TargetCharacter");
	            let activityName = (_a = dictionary[3]) === null || _a === void 0 ? void 0 : _a.ActivityName;
	            if ((target === null || target === void 0 ? void 0 : target.MemberNumber) == Player.MemberNumber && this.CustomIncomingActivityReactions.has(activityName)) {
	    ...
	    RegisterActivities() {
	        ...
	        this.PatchActivity({
	            ...
	            CustomPrereqs: [
	                {
	                    ...
	                    Func: (acting, acted, group) => {
	                        ...
	                        if (group.Name == "ItemEars")
	                            return !this.isPlayerPinching((_a = acted.MemberNumber) !== null && _a !== void 0 ? _a : 0) && this.earPinchingMemberList.length < 2;
	                        return true;
	                    }
	                }
	            ],
	            CustomAction: {
	                Func: (target, args, next) => {
	                    var _a, _b;
	                    var location = (_b = (_a = args[1]) === null || _a === void 0 ? void 0 : _a.Dictionary[2]) === null || _b === void 0 ? void 0 : _b.FocusGroupName;
	            ...
	            CustomPrereqs: [
	                {
	                    ...
	                    Func: (acting, acted, group) => {
	                        ...
	                        if (group.Name == "ItemArms")
	                            return !this.isPlayerGrabbing((_a = acted.MemberNumber) !== null && _a !== void 0 ? _a : 0) && this.armGrabbingMemberList.length < 2;
	                        return true;
	                    }
	                }
	            ],
	    ...
	    InitTongueGrabHooks() {
	            ...
	            CustomPrereqs: [
	                {
	                    ...
	                    Func: (acting, acted, group) => {
	                        if (!this.customGagged)
	                            ...
	                            return this.tongueGrabbedByMember == acted.MemberNumber && (group === null || group === void 0 ? void 0 : group.Name) == "ItemHands";
	                    }
	                }
	            ]
	        });
	        ...
	        hookFunction('ServerSend', 5, (args, next) => {
	            let sendType = args[0];
	            let data = args[1];
	            if (sendType == "ChatRoomChat" && (data === null || data === void 0 ? void 0 : data.Type) == "Activity" && !!(data === null || data === void 0 ? void 0 : data.Dictionary) && !!(data === null || data === void 0 ? void 0 : data.Dictionary[3])) {
	                var activityName = data === null || data === void 0 ? void 0 : data.Dictionary[3].ActivityName;
	        ...
	        hookFunction("ChatRoomDrawCharacterOverlay", 1, (args, next) => {
	            ...
	            if (typeof CharX === "number" &&
	                ...
	                if (this.isPlayerPinchedBy(C.MemberNumber) || this.isPlayerPinching(C.MemberNumber)) {
	                    ...
	                    DrawImageResize(this.isPlayerPinching(C.MemberNumber) ? ICONS.EAR : ICONS.PINCH, CharX + 405 * Zoom, CharY + 45 * Zoom, 30 * Zoom, 30 * Zoom);
	                }
	                else if (this.isHandLeashed(C)) {
	                    DrawCircle(CharX + 420 * Zoom, CharY + 60 * Zoom, 20 * Zoom, 1, "Black", "White");
	                    DrawImageResize(ICONS.HOLD_HANDS, CharX + 400 * Zoom, CharY + 40 * Zoom, 40 * Zoom, 40 * Zoom);
	                }
	                // ROTATE CANVAS TO DRAW ICON IN HERE, if it works it works, if it doesn't -- HO BOY!
	                    ...
	                    DrawImageResize(ICONS.TONGUE, CharX + 125 * Zoom, CharY + 45 * Zoom, 30 * Zoom, 30 * Zoom);
	                }
	            }
	            return ret;
	        }, ModuleCategory.Activities);
	    ...
	    DoGrab(target, type) {
	        ...
	        if (!target.LSCG || !target.MemberNumber || target.MemberNumber == Player.MemberNumber)
	            return;
	        sendLSCGMessage({
	            type: "command",
	            reply: false,
	    ...
	    TryEscape() {
	        ...
	        let grabbingMemberNumber = (_c = (_b = (_a = this.earPinchedByMember) !== null && _a !== void 0 ? _a : this.armGrabbedByMember) !== null && _b !== void 0 ? _b : this.tongueGrabbedByMember) !== null && _c !== void 0 ? _c : -1;
	            ...
	            [
	                {
	                    ...
	                    setting: () => { var _a; return (_a = this.settings.allowBoopRestore) !== null && _a !== void 0 ? _a : true; },
	...
	class InjectorModule extends BaseModule {
	    ...
	    load() {
	        ...
	        OnActivity(10, ModuleCategory.Injector, (data, sender, msg, megadata) => {
	            var _a, _b, _c;
	            var activityName = (_a = data.Dictionary[3]) === null || _a === void 0 ? void 0 : _a.ActivityName;
	            var target = (_b = data.Dictionary.find((d) => d.Tag == "TargetCharacter")) === null || _b === void 0 ? void 0 : _b.MemberNumber;
	            if (!this.Enabled)
	                return;
	            if (target == Player.MemberNumber && activityName == "Inject" && !!sender) {
	                var location = (_c = data.Dictionary[2]) === null || _c === void 0 ? void 0 : _c.FocusGroupName;
	...
	class PublicSettingsModel {
	    constructor() {
	        ...
	        this.LipstickModule = { enabled: false };
	        this.GlobalModule = { enabled: false };
...
${LSCG_CHANGES}`;
	...
	class RemoteHypno extends RemoteGuiSubscreen {
	    ...
	    get overrideMemberIds() {
	        var _a, _b;
	        return (_b = (_a = this.settings.overrideMemberIds) === null || _a === void 0 ? void 0 : _a.split(",").map(id => +id).filter(id => id > 0)) !== null && _b !== void 0 ? _b : [];
	    }
	    get disabledReason() {
	        var _a, _b, _c;
	...
	class RemoteCollar extends RemoteGuiSubscreen {
	    ...
	    get allowedMemberIds() {
	        var _a, _b;
	        let idList = (_b = (_a = this.settings.allowedMembers) === null || _a === void 0 ? void 0 : _a.split(",").map(id => +id).filter(id => id > 0)) !== null && _b !== void 0 ? _b : [];
	        if (this.settings.limitToCrafted && this.settings.collar.creator >= 0)
	...
	class ItemUseModule extends BaseModule {
	    ...
	    getRollMod(C, Opponent, isAggressor = false) {
	        ...
	        let incapacitatedMod = ((_c = getModule("BoopsModule")) === null || _c === void 0 ? void 0 : _c.IsIncapacitated) ? (isAggressor ? 5 : 100) * -1 : 0;
	    ...
	    GiveItem(target, source) {
	        ...
	        InventoryWear(target, item === null || item === void 0 ? void 0 : item.Asset.Name, "ItemHandheld", item === null || item === void 0 ? void 0 : item.Color, item === null || item === void 0 ? void 0 : item.Difficulty, source.MemberNumber, item === null || item === void 0 ? void 0 : item.Craft, true);
	    ...
	    UsedAssetPreparse(args) {
	        var _a, _b, _c;
	        let dict = (_a = args[1]) === null || _a === void 0 ? void 0 : _a.Dictionary;
	        if (!dict)
	            return;
	        let asset = dict.find((x) => x.Tag == "ActivityAsset");
	        let usedAsset = dict.find((x) => x.Tag == "UsedAsset");
	        let targetLocation = (_b = dict[2]) === null || _b === void 0 ? void 0 : _b.FocusGroupName;
	        if (!asset)
	            return;
	        let sourceItemName = asset.AssetName;
	        let sourceGroupName = asset.GroupName;
	        ...
	        if (!!gagTarget)
	            usedAsset.Text = (_c = gagTarget.UsedAssetOverride) !== null && _c !== void 0 ? _c : usedAsset.Text;
	    }
